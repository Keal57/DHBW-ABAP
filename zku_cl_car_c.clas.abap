...
CLASS zku_cl_car_c IMPLEMENTATION.
  ...
  METHOD display_attributes.
    rv_attributes = |{ 'Make:' } { mv_make } { 'Model:' } { mv_model } { 'Production Date:' } { mv_production_date } { 'Horsepower:' } { mv_horsepower } { 'Price' } { mv_price }|.
  ENDMETHOD.
